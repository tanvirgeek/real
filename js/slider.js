...
function init(){
    $('.rotkSliderNext,.rotkSliderPrev').css({width:'54',height:'54'});
    $('.rotkSliderNext').hover(function(){
        $(this).css("background","url('img/arrow-right.png')");
    },function(){
        $(this).css("background","url('img/next-big.png')");
    });
    
    $('.rotkSliderPrev').hover(function(){
        $(this).css("background","url('img/arrow-left.png')");
    },function(){
        $(this).css("background","url('img/prev-big.png')");
    });
